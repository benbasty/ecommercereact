        ...
        <section id="header">
            ...
            <div>
                <ul id='navbar' ref={nav}>
                    ...
                    <li><Link to='/ecommerce' onClick={() => setActiveNav('#home')} className={activeNav === '#home' ? 'active' : ''}>Home</Link></li>
                    <li><Link to='/ecommerce/shop'onClick={() => setActiveNav('#shop')} className={activeNav === '#shop' ? 'active' : ''}>Shop</Link></li>
